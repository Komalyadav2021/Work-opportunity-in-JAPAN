...
/*==================== SWIPER COMPANY ====================*/
let swiper = new Swiper(".companies__container", {
    effect: "coverflow",
    grabCursor: true,
    centeredSlides: true,
    slidesPerView: "auto",
...
async function fetchJobData() {
    ...
    const options = {
        method: 'GET',
        headers: {
            'X-RapidAPI-Key': 'fcc608bd7emsh326bdafae31e2c8p10a37ajsn92746a8be23a',
    ...
    try {
        ...
        // Call a function to display the job data on the page
...
// Function to display job data on the page
function displayJobData(data) {
    // Assuming you have a container to display the job data
    const jobContainer = document.getElementById('job-container');
    
    // Clear any previous job data
    jobContainer.innerHTML = '';

    // Loop through the job data and create HTML elements to display each job
    data.forEach(job => {
...
findJobsButton.addEventListener('click', fetchJobData);
